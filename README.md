...
Welcome to the TODO List App project. This application is a web-based list of tasks developed using vanilla web technologies.
...
>1. Clone this repository: `git clone https://github.com/matiob/TODOList.git`
